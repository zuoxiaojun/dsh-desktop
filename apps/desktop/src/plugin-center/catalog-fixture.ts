...
function preflight(
  ...
  const artifacts: readonly CatalogArtifactEvidence[] =
    summary.scope === "public" && artifact !== undefined
...
export const BUNDLED_CATALOG: CatalogSnapshot = decodeCatalogSnapshot({
  ...
  details: [
    detail(WORKSPACE_TOOLS, {
      description:
        "受审查的安装测试 Bundle；安装后会激活一个 Host 条目，并在侧边栏提供可见的“工作区工具”页面。",
    ...
    detail(SKILL_PACK, {
      description:
        "展示 Skill Pack 如何继续作为一个 DSH Bundle 进入同一目录与后续事务，而不是接受任意 Skill 文件夹或 Git 仓库。",
      permissions: ["安装后向 Harness 注册已审核 Skill 定义。"],
      riskSummary:
        "该 Skill Pack 复用插件兼容与安装边界，不产生第二套安装权威。",
    ...
    detail(LOCAL_BUNDLE, {
      description:
        "本地 Profile 示例，仅用于验证本地范围和不受目录管理的只读状态。",
  ...
  preflights: [
    preflight(WORKSPACE_TOOLS, "@deepseek-ai/dsh-plugin-center-fixture", {
      ...
      artifact: {
        sha256:
          "c7ed790a74a9ba74fa5c9037642a3233fe67a2624a84c8bd368452c09b205e81",
        integrity:
          "sha512-nI72LPDEDLQflFIbq7/kxh889TvJMpGkSslu+Vwq1+Xs1LbknlUHl5UWyJX6dhE7jsh9BzohvghCWjgowWxC3Q==",
        packedBytes: 4_368,
    ...
    preflight(SKILL_PACK, "@deepseek-ai/dsh-plugin-center-skill-fixture", {
      ...
      artifact: {
        sha256:
          "c7cea08358a5b64e1944c9ec49c436eda16c84e78151bb5e52d58bcba36492c2",
        integrity:
          "sha512-4vw9vM5HEnp0ZaSBY8hQGENODss4lCK528McFoz0kheqjqb+KxBNAXr+Tr+bKTF+bP/2stTUiyttQjn2eZZVRA==",
        packedBytes: 3_064,
        unpackedBytes: 5_887,
        fileCount: 10,
      },
