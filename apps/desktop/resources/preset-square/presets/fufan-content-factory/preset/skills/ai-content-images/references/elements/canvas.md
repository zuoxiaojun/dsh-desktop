...
Core canvas specifications and layout grids for Content Platform infographics.

## Aspect Ratios

| Name | Ratio | Pixels | Note |
|------|-------|--------|------|
| portrait-3-4 | 3:4 | 1242×1660 | Highest traffic on Content Platform (recommended) |
