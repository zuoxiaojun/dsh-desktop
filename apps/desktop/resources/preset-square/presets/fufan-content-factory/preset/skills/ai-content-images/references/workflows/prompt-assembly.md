...
Every Content Platform infographic prompt follows this structure:

```
Create a image-card infographic following these guidelines:
...
Include a subtle watermark "@mybrand" positioned at bottom-right
