...
describe('fixed Plugin Center package manager', () => {
  it.each([
    {
      ...
      entry: '/Applications/DSH Desktop.app/Contents/Resources/host/node_modules/pnpm/bin/pnpm.cjs',
      profile: '/Users/fixture/.dsh/profiles/web',
      store: '/Users/fixture/Library/Application Support/DSH Desktop/plugin-store',
      home: '/Users/fixture',
    ...
    },
    {
      ...
      entry: 'C:\\Program Files\\DSH Desktop\\resources\\host\\node_modules\\pnpm\\bin\\pnpm.cjs',
  ...
  it('re-materializes an old Profile without rewriting an incompatible frozen lockfile', async () => {
    ...
    const options = {
      executable: 'C:\\Program Files\\DSH Desktop\\DSH Desktop.exe',
      packageManagerEntry: 'C:\\Program Files\\DSH Desktop\\resources\\host\\node_modules\\pnpm\\bin\\pnpm.cjs',
      profileDirectory: 'C:\\Users\\fixture\\.dsh\\profiles\\web',
      storeDirectory: 'C:\\Users\\fixture\\AppData\\Local\\DSH Desktop\\plugin-store',
