...
const UPDATE_URL = 'https://ml2022.oss-cn-hangzhou.aliyuncs.com/dsh-desktop/releases'
...
describe('packaged desktop runtime verification', () => {
  ...
  it('rejects a packaged shell whose package manager is absent or not pinned', async () => {
    ...
    try {
      const modules = join(appOutDir, 'DSH Desktop.app', 'Contents', 'Resources', 'host', 'node_modules')
      const required = [
        ['@deepseek-ai', 'dsh', 'lib', 'bin.js'],
        ['@deepseek-ai', 'dsh-web-frontend', 'dist', 'index.html'],
        ['@deepseek-ai', 'dsh-web-frontend', 'dist', 'dsh-desktop', 'default-background.webp'],
