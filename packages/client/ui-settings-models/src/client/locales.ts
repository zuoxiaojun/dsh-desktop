...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Configure cloud credentials or connect a local model server.',
  edit: 'Edit',
  ...
  nativeImageInput: 'Allow native image requests',
  nativeImageInputHint: 'Enable only when this exact model endpoint accepts images. Visual Enhancement will route to it automatically.',
  nativeVisionAvailable: 'Visual Enhancement model',
  nativeVisionSharedKey: 'Selected when Visual Enhancement is enabled; uses the existing DeepSeek API key.',
  imageInputBadge: 'Image input',
  addModel: 'Add model',
  ...
  localDescription: 'Choose a running local inference server. The endpoint is prefilled; fetch or enter the models it serves.',
  localFramework: 'Local inference framework',
  localConfigured: 'Already configured',
  localEditorTitle: 'Local model',
  localKeyInput: 'Local API key (optional)',
  localKeyPlaceholder: 'Leave empty when the local server does not require a key',
  localNeedsBaseUrl: 'Enter the local server API address.',
  localNeedsModels: 'Fetch or add at least one local model.',
  localCreate: 'Add local model',
  localCreating: 'Adding\u2026',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '高级设置',
  nativeImageInput: '允许原生图片请求',
  nativeImageInputHint: '仅当该模型接口明确支持图片输入时开启；视觉增强会据此自动选择原生路径。',
  nativeVisionAvailable: '视觉增强模型',
  nativeVisionSharedKey: '开启“视觉增强”时选用，复用现有 DeepSeek API Key。',
  imageInputBadge: '支持图片',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  localAdd: '添加本地模型',
  localTitle: '本地模型',
  localDescription: '选择已经启动的本地推理服务。系统会预填接口地址，再读取或填写该服务提供的模型。',
  localFramework: '本地推理框架',
  localConfigured: '已配置',
  localEditorTitle: '本地模型',
  localKeyInput: '本地 API 密钥（可选）',
  localKeyPlaceholder: '本地服务不需要鉴权时可留空',
  localNeedsBaseUrl: '请填写本地服务的 API 地址。',
  localNeedsModels: '请读取或添加至少一个本地模型。',
  localCreate: '添加本地模型',
  localCreating: '正在添加\u2026',
