...
export const zh = {
  ...
  'access.menu.title': '应如何批准 DeepSeek Harness 操作？',
  'access.menu.readOnlyDescription': '可查看文件；修改文件或执行受限操作时会请求批准',
  'access.menu.workspaceWriteDescription': '可编辑工作区文件；访问工作区外部时会请求批准',
  'access.menu.fullAccessDescription': '可访问互联网，并读取或修改电脑上的任何文件',
  ...
  'image.modelUnsupported': '当前文本模型不支持图片，请先点击“视觉增强”切换图文模型',
  ...
  'chat.toBottom': '回到底部',
  'outline.title': '对话目录',
  'outline.count': '{count} 项',
  'outline.open': '打开对话目录',
  'outline.show': '显示对话目录',
  'outline.collapse': '收起对话目录',
  'outline.hide': '隐藏对话目录',
  'outline.loading': '正在整理完整对话目录…',
  'outline.refreshing': '正在同步完整历史…',
  'outline.error': '完整目录读取失败',
  'outline.partial': '仅显示当前已载入的目录项',
  'outline.empty': '当前会话还没有可导航的消息',
  'outline.locating': '定位中…',
  'outline.targetUnavailable': '目标消息暂时无法载入',
  'outline.role.user': '用户',
  'outline.role.assistant': '助手',
  'outline.role.tool': '工具',
  'outline.fallback.user': '图片消息',
  'outline.fallback.assistant': '图片回复',
  'outline.fallback.tool': '工具调用',
...
export const en = {
  ...
  'access.menu.title': 'How should DeepSeek Harness actions be approved?',
  'access.menu.readOnlyDescription': 'Can inspect files; asks before changing files or performing restricted operations',
  'access.menu.workspaceWriteDescription': 'Can edit workspace files; asks before reaching outside the workspace',
  'access.menu.fullAccessDescription': 'Can access the internet and read or modify any file on this computer',
  ...
  'outline.open': 'Open conversation outline',
  'outline.show': 'Show conversation outline',
  'outline.collapse': 'Collapse conversation outline',
  'outline.hide': 'Hide conversation outline',
  'outline.loading': 'Building the complete conversation outline…',
  'outline.refreshing': 'Syncing complete history…',
  'outline.error': 'Couldn’t load the complete outline',
  'outline.partial': 'Showing only entries in the loaded window',
  'outline.empty': 'This conversation has no messages to navigate yet',
  'outline.locating': 'Locating…',
  'outline.targetUnavailable': 'The target message could not be loaded',
  'outline.role.user': 'You',
  'outline.role.assistant': 'Assistant',
  'outline.role.tool': 'Tool',
  'outline.fallback.user': 'Image message',
  'outline.fallback.assistant': 'Image response',
  'outline.fallback.tool': 'Tool call',
