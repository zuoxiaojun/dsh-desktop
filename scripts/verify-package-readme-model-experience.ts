...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-plugin-center': { kind: 'none', reason: 'Desktop catalog UI and its development marker register nothing model-facing.' },
  'packages/examples/plugin-center-fixture': { kind: 'none', reason: 'The trusted-install fixture exposes browser UI and Host activation evidence but no model context.' },
  'packages/client/ui-desktop-customization': { kind: 'none', reason: 'Desktop-only browser UI; registers nothing model-facing.' },
  ...
  'packages/plugin-center/contracts': { kind: 'none', reason: 'Shared catalog and preflight value contracts register nothing model-facing.' },
